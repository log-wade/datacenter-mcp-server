...
3. **CRITICAL-1 + CRITICAL-2 — OPEN** (battery math) — needs Logan's manufacturer constant-power table / IEEE 485 reference before implementation; golden tests waiting in `tests/golden/ups-sizing.golden.test.ts`.
